...
export const LinkTrigger = ({
  ...
  return (
    <Link
      ...
      rel="noopener"
      id={id}
      className="group/link text-sm inline-flex items-center py-1 px-2 gap-1 relative cursor-pointer bg-transparent border-none  text-secondary hover:text-primary focus-visible:text-primary focus-visible:bg-secondary"
    >
      {children}
