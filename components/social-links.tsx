...
import { createContext, MouseEventHandler, useContext, useState, useRef, ReactNode } from 'react'
...
export const LinkTrigger = ({ id, href, children }: { id: string, href: string, children: ReactNode }) => {
