---
title: 'Infinite marquee animation with React and CSS'
description: 'Infinite marquee animation with React and CSS'
date: "01/07/2021"
---
...
<Image width={602} height={93} src="https://res.cloudinary.com/dliiwavlg/image/upload/v1615160247/slider_twjtwo.gif" alt="Animation example" />
Example on [Next.js website](https://nextjs.org/)_
