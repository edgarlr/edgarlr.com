const projects: TProject[] = [
  ...
  },
  {
    ...
    tech: 'React, Next.js, Typescript, StrapiCMS, PWA, CSS Modules, Tailwind, Workbox, IndexedDB, Google Analytics',
  ...
  },
  {
    ...
    links: [
      ...
      {
        url: 'https://www.figma.com/community/file/945882274406205263/Podcasts---UI-Kit',
        icon: 'Figma',
        title: 'Figma file',
      },
    ],
